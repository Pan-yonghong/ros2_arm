...
from assembly_robot.asmbrobot_follow_joint_trajectory_client import FollowJointTrajectoryClient
...
def main(args=None):
    ...
    controller = FollowJointTrajectoryClient('asmbrobot_controller', '/asmbrobot/asmb_right_arm_joint_trajectory_controller')

    # 向控制器发送轨迹目标GOAL，其中10是超时时间（单位为秒）。
    controller.send_goal(GOAL, 16)
